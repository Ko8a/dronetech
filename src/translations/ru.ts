export const ruTranslations = {
  ...
  team_kim_title: 'Директор по образованию',
  team_kim_bio: 'Образовательный технолог, специализирующийся на разработке учебных программ для обучения техническим навыкам.',
  team_volkov_name: 'Сергей Волков',
  team_volkov_title: 'Главный пилот',
  team_volkov_bio: 'Бывший военный летчик с обширным опытом обучения операторов БПЛА для выполнения сложных миссий.',
