...
export const ruTranslations = {
  ...
  team_petrov_name: 'Маханбеткали Кобыланды',
  ...
  team_volkov_bio: 'Руководитель отдела разработки и иноваций. Имеет опыт работы с Беспилотными системами и радиоэлектроникой. Участник WorldSkills Lyon, Электроника',
  ...
  eventVenue: 'Школа Зерде, Толе Би 26',
