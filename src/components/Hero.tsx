    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="container mx-auto px-6 py-12 md:py-24 flex flex-col items-center justify-center text-center relative z-10 text-white">
        <AnimatedElement animation="animate-fade-in" delay={200}>
          <img 
            src="/lovable-uploads/dronetech-logo-stacked.png" 
            alt="DroneTech" 
        ...
        <AnimatedElement animation="animate-fade-in" delay={800}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              to="/training"
              className="inline-flex items-center rounded-lg bg-white/10 backdrop-blur-sm px-8 py-3 text-sm font-medium text-white transition-colors hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/20 focus:ring-offset-2"
            >
              Start Training
            </Link>
          </div>
      ...
      <div className="absolute bottom-10 left-0 right-0 flex justify-center animate-bounce">
        <button 
          onClick={scrollToNextSection} 
          className="w-10 h-10 flex items-center justify-center rounded-full bg-white/20 backdrop-blur-sm border border-white/30"
        >
