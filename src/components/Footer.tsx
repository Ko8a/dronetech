    ...
    <footer className="bg-foreground text-white py-16 px-6 md:px-10 lg:px-20">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <h3 className="font-display font-bold text-xl mb-6">DroneTech</h3>
            <p className="text-gray-300 mb-6 max-w-md">
              Cutting-edge drone solutions designed with precision and elegance for professionals and enthusiasts.
            </p>
            <p className="text-gray-400 text-sm">
              &copy; {currentYear} DroneTech Inc. All rights reserved.
            </p>
          </div>
          
          <div>
            <h4 className="font-bold text-gray-200 mb-6">Products</h4>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">SkyView Pro X</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">NanoExplorer</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">AeroMap Enterprise</a>
              </li>
              <li>
          ...
          <div>
            <h4 className="font-bold text-gray-200 mb-6">Company</h4>
            <ul className="space-y-3">
              <li>
          ...
          <div>
            <h4 className="font-bold text-gray-200 mb-6">Support</h4>
            <ul className="space-y-3">
              <li>
